            ...
            <div @mouseleave="currentIndex = -1">
                ...
                <div class="sort">
                    <div class="all-sort-list2">
                        <div class="item" :class="{itemHover: index == currentIndex}" v-for="(item1, index) in threeListData.slice(0, 15)" :key="item1.categoryId">
...
export default {
    ...
    computed: {
        ...mapState('home', {threeListData: 'threeListData'})
        // ...mapState({
        //     threeListData:state => state.home.threeListData
        // })
    },
    mounted() {
        this.$store.dispatch('home/getThreeList');
    },
    methods: {
        changeItemCss(i) {
            this.currentIndex = i
